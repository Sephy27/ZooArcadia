...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, Security $security,JWTService $jwt,SendEmailService $mail, EntityManagerInterface $entityManager): Response
    {
        $user = new Users();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Envoyer l'e-mail
            $mail->send(
                'no-reply@zooarcadia.test',
                $user->getEmail(),
                'Activation de votre compte sur le site ZooArcadia',
                'register',
